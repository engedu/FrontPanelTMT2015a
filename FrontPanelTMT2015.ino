// TMT LCD Panel  20x4 
// ------------------------------------
// config fuse bit on Atmega328 via AVRDUDE
// d:\Arduino\hardware\tools\avr\bin\avrdude "-Cd:\Arduino\hardware\tools\avr/etc/avrdude.conf" -v -patmega328p -cstk500v1 -PCOM6 -b19200  -U lfuse:w:0x6E:m
// https://sites.google.com/a/kmitl.ac.th/koson-trachu/embedded-system/arduino-lab/avr-dude-fuse-bit
// -------------------------------------
//
// error in ibrary  "LiquidCrystal_I2C"
// inline size_t LiquidCrystal_I2C::write(uint8_t value) {
//	send(value, Rs);
//	return 1; <-- add return 1;
//  }
// http://forum.arduino.cc/index.php?PHPSESSID=dam2sjhf6bgbc1m00uu1qtv897&topic=361411.0
// --------------------------------------

// work on 59.05.06, 03:30
